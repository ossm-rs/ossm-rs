...
impl Pattern for Insist {
    const NAME: &'static str = "Insist";
    const DESCRIPTION: &'static str = "Pulls out less with every stroke. Sensation controls the number of steps.";
